...
<html>
    ...
    <body>
        ...
        <div id="content">
            ...
            <img style="display: none;" src="<?php echo DIAGRAMO?>/install.php?step=step4&version=<?php echo VERSION?>&session=<?php echo session_id()?>&url=<?php echo urlencode($appUrl)?>"/>
