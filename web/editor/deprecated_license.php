            ...
            <div id="content"  style="text-align: center; background-color: #F6F6F6">
                ...
                <div class="form" style="width: 400px; text-align: left; ">
                    ...
                    <div style="text-align: left; /*letter-spacing: 0.1em;*/ line-height: 200%; padding-left: 10px;">
                        ...
                        If you do not have a serial please <a href="<?php echo $DIAGRAMO?>/buy.php" target="_blank"><img style="vertical-align: middle;" src="assets/images/buy.png" /></a> one.<br/>                        
                    </div>
                ...
                ?>
                    ...
                    <br/>
                    Host: <?php echo $l->host?>
                    <br/>
                    Serial: <?php echo $l->serial?>
                <?php }?>
            </div>
